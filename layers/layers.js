...
lyr_mergelotpa_1.set('fieldLabels', {'FID': 'hidden field', 'no_lot': 'header label - visible with data', 'area': 'header label - visible with data', 'tsp — hakm': 'no label', 'tsp — ha_1': 'no label', 'tsp — pemi': 'no label', 'layer': 'hidden field', 'path': 'hidden field', });
